...
export { getWeatherData, displayWeatherData };

// Example usage (Node.js) - only if running in Node.js
if (typeof window === 'undefined') {
  (async () => {
    try {
      ...
      // Create a mock DOM element to display the data (for Node.js)
      const targetElement = {
        innerHTML: "" ,
      };
      displayWeatherData(weatherData, targetElement);
      console.log(targetElement.innerHTML); // Output the generated HTML
    } catch (error) {
